...
namespace config {
    ...
    private:
        ...
        void parse_keyboard(xml_node* node, const config_key& key);
        void parse_key(xml_node* node, const config_key& key);
        ...
        void parse_emitter(xml_node* node, const config_key& key);
